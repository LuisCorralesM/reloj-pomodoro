...
class AppPomodoro extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      brkLength: 5,
  ...
  render() {
    return (
      <div className="contenedor-reloj">
        <div className="enunciado-reloj">25 + 5 Clock</div>
        <div className="contenedor-config-reloj">
        ...
        <div className="contenedor-config-footer">
